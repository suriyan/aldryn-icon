...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Icon'
        db.create_table(u'aldryn_icon_icon', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='icons/tango/32x32/actions/address-book-new.png', max_length=150, null=True, blank=True)),
        ...
        db.send_create_signal(u'aldryn_icon', ['Icon'])


    def backwards(self, orm):
        # Deleting model 'Icon'
        db.delete_table(u'aldryn_icon_icon')
    ...
    models = {
        u'aldryn_icon.icon': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'icons/tango/32x32/actions/address-book-new.png'", 'max_length': '150', 'null': 'True', 'blank': 'True'}),
